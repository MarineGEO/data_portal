...
if(nrow(failed_submissions) > 0){
  ...
  cat("We'll review these files and, if necessary, will reach out to data submitters with additional information or instructions. If you have any questions or concerns regarding this submission, please email us at  marinegeo@si.edu.")
} else {
