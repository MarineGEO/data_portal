...
if(nrow(failed_submissions) > 0){
  ...
  cat("We'll review any files that failed to successfully transmit to our database and will reach out to data submitters with additional information or instructions. If you have any questions or concerns regarding this submission, please email MarineGEO (marinegeo@si.edu).")
} else {
  cat("MarineGEO will review this submission and reach out to you if necessary. If you have any questions or concerns regarding this submission, please email MarineGEO (marinegeo@si.edu).")
}
