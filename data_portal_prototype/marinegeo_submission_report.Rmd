...
if(!(nrow(csv_submissions) > 0 & "sed-biome" %in% output_metadata$protocol$protocol)){
  
  cat("You've submitted a data entry spreadsheet for the SED-BIOME protocol but did not include hobo logger data in CSV format. If you submitted the logger data previously or submitted it as a Microsoft Excel file during this submission, then you do not need to take any further action. Otherwise, please email your logger data to marinegeo-data@si.edu in any format. Thank you!")
} else {
  
  cat("Your SED-BIOME data submission is complete!")
}
