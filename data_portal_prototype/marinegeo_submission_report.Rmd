...
if(!(nrow(csv_submissions) > 0 & "sed-biome" %in% output_metadata$protocol$protocol)){
  ...
  cat("You've submitted a data entry spreadsheet for the SED-BIOME protocol, but did not include hobo logger data in CSV format. Please email your logger data to   to  marinegeo-data@si.edu. If you submitted the logger previously, thank you!")
} else {
