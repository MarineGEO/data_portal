           ...
           tabPanel("Data Policy",
                    ...
                    absolutePanel(
                      ...
                      div(
                        ...
                        or participation in any MarineGEO activity that involves data collection.",

                        tags$h4("Terms & Definitions"),
                        "MarineGEO refers to both the Marine Global Earth Observatory research program and the broader community
                        (network) of partners that conduct its activities, which are led and coordinated by the MarineGEO Central
                        Team at the Smithsonian Institution.", tags$br(),

                        "MarineGEO Central refers to the leadership and support team, based at the Smithsonian,
                        that coordinates MarineGEO activities. MarineGEO Central is responsible for collating, curating,
                        archiving, and serving MarineGEO data to contributing participants and, where appropriate, to the public.", tags$br(),

                        "Data refers to all content generated by MarineGEO activities,
                        including measurements stored in spreadsheets and on original field sheets,
                        images, video, genetic sequences, GIS layers, computer code, and associated metadata.", tags$br(),

                        "A contributing participant is any party who has collected and contributed original data to MarineGEO.
                        Participants can include principal investigators, technicians, students, and/or volunteers at
                        MarineGEO partner institutions, as well as those contributing to a MarineGEO project by mutual agreement.",
                        ...
                        resources provided by MarineGEO, including protocols, field sheets, and data entry spreadsheets.",

                        tags$h4("Data Submission"),
                        ...
                        can be embargoed for a term specified by mutual agreement before public release.  ", tags$br(),
                        ...
                        If you do not wish for such information to be made public, please indicate so during data submission. ", tags$br(),

                        "Approximately two years after the initial submission, MarineGEO intends to make all applicable data available on public
                        repositories with proper attribution (see Table 1 and Data Attribution).", tags$br(),

                        tags$h4("Data Sharing"),
                        "Contributing participants own the raw data they collect.", tags$br(),
                        ...
                        discretion of MarineGEO Central Team.", tags$br(),
                        "Sharing data collected by another MarineGEO partner with parties outside the network prior to public release
                        requires the prior written approval of the contributing participant(s) who generated the data and the MarineGEO Central Team.", tags$br(),
